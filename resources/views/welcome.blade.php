...
<body>
        ...
        <div class="business-grid">
            <div class="business-card retail">
                <div>
                    ...
                    <p data-i18n="retail_desc">Stores "at home", fairs, wholesale and retail markets — accepting cash payments</p>
                </div>
            ...
            <div class="business-card catering">
                <div class="catering-text">
                    ...
                    <p data-i18n="catering_desc">Cafes, restaurants, coffee shops that accept cashless payments on the website and in the app</p>
                </div>
            ...
            <div class="business-card cashier">
                ...
                <p data-i18n="cashier_desc">Use the cashier to accept cash payments or non-cash payments on your own website</p>
            </div>
        </div>
    </section>
    ...
    <section class="payment-automation">
        <div class="payment-content">
            ...
            <p data-i18n="receipt_text">Connect the POS payment terminal to SmartKasip and automate the issuance of checks to customers</p>
        </div>
    ...
    <section class="devices">
        ...
        <p data-i18n="device_desc">Accept payments and issue receipts without buying a cash register immediately after registering with SmartKasip</p>
